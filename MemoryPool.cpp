...
size_t check_align_block(size_t size)
{
    ...
    printf("check_align_block align = [%lu]\n", align);
    return size - align;
}
/************************************************************************/
...
{
    printf("sizeof(memory_block) = [%lu] , sizeof(memory_chunk) = [%lu]\n", sizeof(memory_block), sizeof(memory_chunk));
    // 初始化该内存块
    ...
    printf("sizeof(memory_block) = [%lu] , mem_pool->mem_map_unit_count = [%lu]\n", sizeof(memory_block), mem_pool->mem_map_unit_count);
    printf("sizeof(memory_block) * mem_pool->mem_map_unit_count = [%lu]\n", (sizeof(memory_block) * mem_pool->mem_map_unit_count));
    // memory
    ...
    printf("sizeof(memory_block) * mem_pool->mem_map_unit_count = [%lu]\n", (sizeof(memory_block) * mem_pool->mem_map_unit_count));
    printf("sizeof(memory_chunk) * mem_pool->mem_map_pool_count = [%lu]\n", (sizeof(memory_chunk) * mem_pool->mem_map_pool_count));
    printf("mem_pool_struct_size+ sizeof(memory_block) * mem_pool->mem_map_unit_count + sizeof(memory_chunk) * mem_pool->mem_map_pool_count = [%lu]\n", (mem_pool_struct_size + sizeof(memory_block) * mem_pool->mem_map_unit_count + sizeof(memory_chunk) * mem_pool->mem_map_pool_count));
    ...
    printf("mem_pool->pmem_map[0].count = [%lu]\n", mem_pool->pmem_map[0].count);
